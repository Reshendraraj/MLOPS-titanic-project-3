...
def predict():
    try:
        ...
        Age_Fare=int(data["Age_Fare"])

        features = pd.DataFrame([[Age,Fare,Pclass,sex,Embarked,Familysize,Isalone,HasCabin,Title,Pclass_Fare,Age_Fare]] , columns=FEATURES_NAMES)
